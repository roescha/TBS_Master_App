...
class TestGateDirectional:
    ...
    def test_nominal_pass_plus_dominant(self, metrics):
        ...
        result = _gate_directional(
            ...
            adx_t=25.0, adx_t1=24.0, metrics=metrics,
        )
        assert result is None

    def test_nominal_fail_minus_dominant(self, metrics):
    ...
    def test_boundary_di_equal(self, metrics):
    ...
    def test_variant_profile_a_ema_stack_exemption(self, metrics):
    ...
    def test_variant_profile_a_no_ema_exemption(self, metrics):
    ...
    def test_variant_profile_b_trending_exemption(self, metrics):
    ...
    def test_variant_profile_b_trending_no_full_stack(self, metrics):
    ...
    def test_variant_profile_c_counter_cyclical_exemption(self, metrics):
    ...
    def test_variant_profile_c_no_exemption_far_from_floor(self, metrics):
    ...
    def test_variant_profile_c_negative_adx_slope(self, metrics):
    ...
    def test_variant_nan_di_values(self, metrics):
    ...
    def test_variant_nan_di_minus(self, metrics):
    ...
    def test_variant_profile_c_boundary_5pct(self, metrics):
